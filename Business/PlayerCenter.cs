...
namespace GTI.Modules.PlayerCenter.Business
{
    ...
    public sealed class PlayerManager
    {
        ...
        /// </summary>
        /// <param name="playerListFilters"></param>
        internal void StartAwardPointsToPlayerList(PlayerListParams playerListFilters)
        {
            ...
            m_worker.ProgressChanged += new ProgressChangedEventHandler(m_waitForm.ReportProgress);
            m_worker.RunWorkerCompleted += new RunWorkerCompletedEventHandler(AwardPointsToPlayerListComplete);
            m_worker.RunWorkerAsync(playerListFilters);
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AwardPointsToPlayerListComplete(object sender, RunWorkerCompletedEventArgs e)
        {
            // Set the error that occurred (if any).
            LastAsyncException = e.Error;

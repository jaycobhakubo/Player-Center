...
namespace GTI.Modules.PlayerCenter.Data
{
    ...
    /// </summary>
    internal class CreateNewPlayerMessage : ServerMessage
    {
        ...
        /// </summary>
        public CreateNewPlayerMessage()
        {
            m_id = 8010; // Create New Player
        }
        #endregion
        ...
        protected override void UnpackResponse()
        {
            ...
            if(responseStream.Length != ResponseMessageLength)
                throw new MessageWrongSizeException("Create New Player");
            ...
            //if (m_playerId <1)
            //    throw new ServerException("Create New Player returned <1 playerid");
        ...
        /// <summary>
        /// Gets the id of the newly created player received from the server.
        /// </summary>
        public int PlayerId
        {
            get

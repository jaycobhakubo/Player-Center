...
{
    class GetPlayerListDefinition  : ServerMessage
    {
        ...
        public List<PlayerListDefinition>  GetPlayerListDefinitionMSG()
        {
            ...
            {
                throw new Exception("GetPlayerListDefinition: " + ex.Message);
            }
        ...
        protected override void UnpackResponse()
        {
            ...
            {
                throw new MessageWrongSizeException("GetPlayerListDefinition:", e);
            }
            catch (Exception e)
            {
                throw new ServerException("GetPlayerListDefinition:", e);
            }

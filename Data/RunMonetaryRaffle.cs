...
{
    /// <summary>
    /// Represents a message to the server that tells it to run the sent in monetary raffle and returns the result
    /// </summary>
    public class RunMonetaryRaffle : ServerMessage
    {
        #region Private Members

        private int m_raffleID;
        private decimal m_win;
        ...
        public RunMonetaryRaffle(int id)
        {
            m_id = 18242;
            m_strMessageName = "Run Monetary Raffle";
        ...
        /// <returns></returns>
        public static Decimal RunRaffle(int id)
        {
            var msg = new RunMonetaryRaffle(id);
            try
            {
                msg.Send();
            }

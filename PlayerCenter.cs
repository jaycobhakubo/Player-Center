...
namespace GTI.Modules.PlayerCenter.Business
{
    ...
    public sealed class PlayerManager
    {
       ...
       // private int m_workstationId = 0;
        ...
        //knc|5/28/13|US2649: Added  <start>
        ...
        {
            ListLocationCountry = GetPlayerLocationPer.CountryName;//test if it works  
        }
        //knc|5/28/13|US2649: Added <end>

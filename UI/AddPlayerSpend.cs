...
{
    public partial class AddPlayerSpend : EliteGradientForm
    {
        #region Members
        ...
        public AddPlayerSpend(string playerName, int playerId)//No need to send the whole player object I just need this 2.
        {
            InitializeComponent();

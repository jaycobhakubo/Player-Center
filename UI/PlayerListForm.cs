        ...
        protected void m_loadLocaListBox(int selectedindex)
        {
            ...
            else if (selectedindex == 1)
            {
                ...
                foreach (LocationState State in PlayerManager.ListLocationState)
                {
                    ...
                    State2 = System.Threading.Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(State2.ToLower());
                    m_locListBox.Items.Add(State2);
            ...
            else if (selectedindex == 2)
            {
                ...
                {
                    string PostalCode2 = PostalCode.ToString();
                    PostalCode2 = System.Threading.Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(PostalCode2.ToLower());
                    m_locListBox.Items.Add(PostalCode2);
                    //m_locListBox.Items.Add(PostalCode.ZipCode);
                }
            }
